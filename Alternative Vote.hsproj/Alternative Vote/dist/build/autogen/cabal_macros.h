...
/* package AlternativeVote-1.0 */
#define VERSION_AlternativeVote "1.0"
#define MIN_VERSION_AlternativeVote(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "AlternativeVote-1.0"

#define CURRENT_PACKAGE_KEY "AlternativeVote-1.0"
